...
та записаного фактичного виводу namespaces. Використання власного домену
звірено з повідомленням куратора; скрин листування не додається за рішенням користувача.
