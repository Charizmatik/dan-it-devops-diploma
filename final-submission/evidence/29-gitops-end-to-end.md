...
## Звірка з роз’ясненням куратора

Користувач надав повідомлення куратора для перевірки відповідності. Власний
домен дозволений для власного AWS-акаунта. Скрин листування не додається за
...
Terraform state зараз локальний. S3 backend є лише опційним шаблоном;
віддалене зберігання state не видається за виконане. Письмове завдання не
містить окремої вимоги S3, а куратор дозволяє адаптувати Terraform-код.
